        ...
        <section className=" min-h-screen">
          <nav className=" py-10 mb-12 flex justify-between">
            ...
            <ul className=" flex justify-center gap-6 lg:gap-20">
              ...
              <li className="dark:text-gray-200">
                <a href="https://drive.google.com/file/d/126LOCTTi6mzzsZ0FMlbp0qDRY8PzkWHs/view?usp=sharing" target="blank" className=" bg-cyan-800 text-gray-200 px-2 py-1 rounded-md text-sm lg:text-xl lg:px-4 lg:py-2 dark:bg-teal-400">
                  Resume
                </a>
              </li>
            </ul>
